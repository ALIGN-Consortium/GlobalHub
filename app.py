...
app_ui = ui.page_navbar(
    ...
    title=ui.tags.div(
        ui.tags.img(
            src="logo/without_partners.png", height="40px", style="margin-right: 10px;"
        ),
    ...
    footer=ui.tags.footer(
        ui.tags.hr(),
        ui.tags.img(
            src="logo/with_partners.png", height="120px", style="margin-bottom: 10px;"
        ),
        ui.p("© 2026 ALIGN Consortium. All rights reserved."),
        ui.p(
            "Contact: ",
            ui.tags.a("placeholder@example.com", href="mailto:placeholder@example.com"),
        ),
