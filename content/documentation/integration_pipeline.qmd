...
The pipeline is maintained as a set of Python and R scripts located in the `scripts/` directory of the repository.
- **`data_harmonizer.py`**: The primary Python script for cleaning and merging data.
- **`data_conversion_horizon.R`**: R scripts used for specific data transformation tasks.

For more information on the technical implementation, refer to the [Technical Architecture Guide](technical_guide.html).
